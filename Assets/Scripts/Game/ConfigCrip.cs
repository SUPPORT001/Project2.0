...
public static class ConfigCrip : object
{
    ...
    public static float knight_speedATK = 20;
    public static float knight_distant = 2;
    ...
    public static float archer_speedATK = 20;
    public static float archer_distant = 5;
    ...
    public static float rex_speedATK = 10;
    public static float rex_distant = 2;
    ...
    public static float wizard_speedATK = 20;
    public static float wizard_distant = 5;
    ...
    public static float tank_speedATK = 20;
    public static float tank_distant = 2;
    public static string tank_typeAttack = "Melee";
    public static int tank_moneyCost = 100;
}
